...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! . */ "./HOCs/Session/index.js");
...
var withAuthorization = function withAuthorization(condition) {
  return function (Component) {
    ...
    function (_React$Component) {
      ...
      Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(WithAuthorization, [{
        ...
        value: function componentDidMount() {
          this.listener = this.props.firebase.auth.onAuthStateChanged(function (authUser) {
            ...
            if (!condition(authUser)) {
              next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push('/signin');
            }
          });
        }
      }, {
        ...
        value: function render() {
          ...
          return __jsx(___WEBPACK_IMPORTED_MODULE_10__["AuthUserContext"].Consumer, {
            __source: {
    ...
    ___WEBPACK_IMPORTED_MODULE_9__["withFirebase"])(WithAuthorization);
  };
};
...
//# sourceMappingURL=home.js.91bf7f2c9a4d3211c754.hot-update.js.map